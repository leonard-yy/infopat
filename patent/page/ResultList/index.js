    ...
    if (res.patents && res.patents.length > 0) {
      ...
      <div class="tips"> 
        ...
        <div class="tip-container">
          ...
          <div class="tips-line"><span class="point">•</span> 检索条件不正确。请您核对是否对搜索条件进行了不正确的字段限定。<a target="_blank" href="/main/help.html" class="hl">查看帮助文档</a></div>
          <div class="tips-line"><span class="point">•</span> 检索的号码格式不正确。请核对是否输入了符合infoDossier要求的号码格式。<a target="_blank" href="/main/help.html" class="hl">查看帮助文档</a></div>
          ...
          <div class="tips-line"><span class="point">•</span>更复杂的逻辑查询请参考右上角的<a target="_blank" href="/main/help.html" class="hl">《帮助文档》</a></div>
        </div>
      </div>
      `;
      $("#fieldsContent").html(html);
