function initPage() {
  layui.use(["patNodataPage", "element", "layer", "request", "laypage"], function () {
    ...
    var data = [
      {
        document_number: "CN103997389B",
        title: "一种计算PDSCH信道中NULL比特数的方法和装置",
        document_date: "2018-10-02",
        application_date: "2013-02-20",
        applicant: "中兴通讯股份有限公司",
        inventor: "邓春华; 李爱军",
      },
      {
        document_number: "CN104041073A",
        title: "近场零位与波束成形",
        document_date: "2014-09-10",
        application_date: "2012-09-28",
        applicant: "苹果公司",
        inventor: "R·N·艾萨克; M·E.·约翰逊",
      },
      {
        document_number: "CN107407494B",
        title: "空调",
        document_date: "2020-02-28",
        application_date: "2016-03-29",
        applicant: "日立江森自控空调有限公司",
        inventor: "德地干人; 谷和彦; 秋山义幸; 稻叶雅美; 太田贵文",
      },
    ];
    if (data && data.length > 0) {
      var html = '<table class="layui-table" lay-even="" lay-skin="nob">';
