function initPage() {
  layui.use(["laytpl", "layer", "form", "request"], function () {
    ...
    var content = `国产电子器件替代验证项目确定方法及设备<br/>

    技术领域<br/>
    
    本发明涉及电子器件领域，尤其涉及一种国产电子器件替代验证项目确定方法及设备。<br/>
    ...
    本发明实施例提供一种国产电子器件替代验证项目确定方法及设备，用以解决现有技术中航天应用验证技术无法用于替代验证项目的确定并且只适用于特定器件的问题。<br/>
    <br/>
    本发明实施例提供一种国产电子器件替代验证项目确定方法，包括：<br/>
    
    步骤1，获取国产电子器件和国外电子器件的产品信息，以及使用国产电子器件和国外电子器件的电子产品的设计要求信息，并提取产品信息中的特性参数；<br/>
    
    步骤2，对比从国产电子器件和国外电子器件的产品信息中提取的特性参数，并基于所述电子产品的设计要求信息确定最终待验证特性参数；<br/>
    
    步骤3，根据最终待验证特性参数确定最终替代验证项目信息。<br/>
    <br/>
    优选地，对比从国产电子器件和国外电子器件的产品信息中提取的特性参数，并基于所述电子产品的设计要求信息确定最终待验证特性参数，包括：<br/>
    
    对比从国产电子器件和国外电子器件的产品信息中提取的特性参数，筛选得到初步待验证特性参数；<br/>
    
    从初步待验证参数中筛选出第一部分待验证特性参数以及第二部分待验证特性参数；<br/>
    
    将第一部分待验证特性参数与第二部分待验证特性参数合并，得到最终待验证特性参数。<br/>
